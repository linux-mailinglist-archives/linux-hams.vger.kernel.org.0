Return-Path: <linux-hams+bounces-555-lists+linux-hams=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-hams@lfdr.de
Delivered-To: lists+linux-hams@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id C69DFB1F45A
	for <lists+linux-hams@lfdr.de>; Sat,  9 Aug 2025 13:24:02 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 5C562726800
	for <lists+linux-hams@lfdr.de>; Sat,  9 Aug 2025 11:24:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id ADB88266580;
	Sat,  9 Aug 2025 11:23:57 +0000 (UTC)
X-Original-To: linux-hams@vger.kernel.org
Received: from vps001.vanheusden.com (fatelectron.soleus.nu [94.142.246.159])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 49A71262FE6
	for <linux-hams@vger.kernel.org>; Sat,  9 Aug 2025 11:23:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=94.142.246.159
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1754738637; cv=none; b=JjE8N3OxqKA7fqEkdeHhBvX6FOMKcG643bj1dxqk+0/SGy2EcS3wsCP6Du9qHjbQjzwXIpE0A51UX3dk8HBeqlOOiR11HYKmVOvAWpJyt0Z4rBZpQMBqM/QgHxSJf7a/K0Dhyf1LWXK2rPdaeBVl1JhP86wDfdFYyvIl03BY8wk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1754738637; c=relaxed/simple;
	bh=G0VaN9JUyziJw7dD9LWz12rhzMFF9VS0XkMHrmpCZo8=;
	h=MIME-Version:Date:From:To:Subject:In-Reply-To:References:
	 Message-ID:Content-Type; b=IQkBDeHG1KYrtovZ+JG9iRobNjku9GAREiznLVfvAcaSIlQJuo6yGaUzyYH9dBiihvGnldk5wFV6KSnkjoYsBE9xBFUS496CH3NHT5BI9pBLRfLz2Y+NAmv5mxn5HS35ld4lZQt5FsmPRns5w0MZUZkgs9BAq7R9GgnwvCnlmi0=
...
Received: from webmail.vanheusden.com (unknown [172.29.0.1])
	by vps001.vanheusden.com (Postfix) with ESMTPA id DDF4C500623
	for <linux-hams@vger.kernel.org>; Sat, 09 Aug 2025 13:23:43 +0200 (CEST)
Precedence: bulk
...
MIME-Version: 1.0
Date: Sat, 09 Aug 2025 13:23:43 +0200
From: Folkert van Heusden <folkert@vanheusden.com>
To: linux-hams@vger.kernel.org
Subject: Re: crash
In-Reply-To: <30172f07ac135c4996c5023a66de2afa@vanheusden.com>
References: <7c4ff0c7c6faa8722e858c92f6456dc7@vanheusden.com>
 ...
 <0c6c5375-2b0e-42aa-bb1b-e676acd1dfa2@vk6hgr.echidna.id.au>
 <30172f07ac135c4996c5023a66de2afa@vanheusden.com>
Message-ID: <b1759044da63f07d658e78d5d9a9a685@vanheusden.com>
...
root@27mc5:~# axcall loop MYCALL-1
GW4PTS AX.25 Connect v1.11
Trying...

connect: Address already in use

This is the setup (did not replace your ip-address, but not using ip 
anyway):

ax0: flags=67<UP,BROADCAST,RUNNING>  mtu 250
         inet 44.136.204.77  netmask 255.0.0.0  broadcast 44.255.255.255
         ax25 MYCALL-1  txqueuelen 10  (AMPR AX.25)
         RX packets 14  bytes 226 (226.0 B)
         RX errors 0  dropped 0  overruns 0  frame 0
         TX packets 14  bytes 282 (282.0 B)
         TX errors 0  dropped 0 overruns 0  carrier 0  collisions 0

/etc/ax25/axports
loop    MYCALL-1        9600    250     6       Loopback device

On 2025-08-08 09:49, Gavin Rogers wrote:
...
> VK6HGR
> 
> On 8/08/2025 3:34 pm, Folkert van Heusden wrote: I tried to explain it 
> with a drawing: https://vanheusden.com/permshare/ ax25crash.png
> 
...
> trigger anything.
> 
> On 2025-08-08 00:18, David Ranch wrote: Can you tell us EXACTLY what 
> you're doing so others can try to reproduce the crash?  What specific 
> distro and kernel version are you running on your Rpi5?
> 
> --David
> KI6ZHD
> 
> https://vanheusden.com/permshare/ax25crash.png
> On 08/07/2025 10:37 AM, Folkert van Heusden wrote: Ok, I succeed (quite 
> easily) to trigger the crash.
> 
