Return-Path: <linux-hams+bounces-554-lists+linux-hams=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-hams@lfdr.de
Delivered-To: lists+linux-hams@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 40FD6B1E40F
	for <lists+linux-hams@lfdr.de>; Fri,  8 Aug 2025 10:04:52 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id D6B313AD8EE
	for <lists+linux-hams@lfdr.de>; Fri,  8 Aug 2025 08:04:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8EF612236EB;
	Fri,  8 Aug 2025 08:04:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=smtpservice.net header.i=@smtpservice.net header.b="pHK9K+PU";
	dkim=pass (2048-bit key) header.d=vk6hgr.echidna.id.au header.i=@vk6hgr.echidna.id.au header.b="WonX7OBo"
X-Original-To: linux-hams@vger.kernel.org
Received: from o1i318.smtp2go.com (o1i318.smtp2go.com [170.10.69.62])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id ACD7E24166F
	for <linux-hams@vger.kernel.org>; Fri,  8 Aug 2025 08:04:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.69.62
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1754640287; cv=none; b=ZVJd1ju0bKix3v+q5Ua5NoPVbgf+A2AdfvcgAtr0zHfjleC47kJUa0+ohxhOGzLfvV45SvTcEwubkEPeMZmga5+COmmSuXcoIvCRBipcmtiTOCH534NfV/zweK2oG+9SgIwlqslGItxtHqXTcQmJmZIb0Wgyqkndpz+JT0SvSn0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1754640287; c=relaxed/simple;
	bh=8HDAEnOF9nMdvFImyFFOfGvvB0/D5A3nU+wBVa8ih4Q=;
	h=Message-ID:Date:MIME-Version:From:To:References:In-Reply-To:
	 Content-Type:Subject; b=KdFiu6/NkKSs+3DHJgrRsoABViW+0o7U2jjwuPkNBZBL6uGd5UlaTTKpMn1C3QykolsCP/6vSpvA1/Y6U3LemgjtKrljAbUQsKaWQfKRzxVf9Cr9upmR2u0u05w81QjVP3HkdZq7HqDEIwf87mCDugBR/irKsu5KmyA91IyyYjU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=vk6hgr.echidna.id.au; spf=pass smtp.mailfrom=em470653.vk6hgr.echidna.id.au; dkim=pass (2048-bit key) header.d=smtpservice.net header.i=@smtpservice.net header.b=pHK9K+PU; dkim=pass (2048-bit key) header.d=vk6hgr.echidna.id.au header.i=@vk6hgr.echidna.id.au header.b=WonX7OBo; arc=none smtp.client-ip=170.10.69.62
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=vk6hgr.echidna.id.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=em470653.vk6hgr.echidna.id.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=smtpservice.net;
 i=@smtpservice.net; q=dns/txt; s=a1-4; t=1754639371; h=feedback-id :
 x-smtpcorp-track : date : message-id : to : subject : from : reply-to
 : sender : list-unsubscribe : list-unsubscribe-post;
 bh=lfwtgkHOynUsKfv//gxNvbIan19HtvLLEBFoJoRZ7xI=;
 b=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=vk6hgr.echidna.id.au; i=@vk6hgr.echidna.id.au; q=dns/txt; s=s470653;
 t=1754639371; h=from : subject : to : message-id : date;
 bh=lfwtgkHOynUsKfv//gxNvbIan19HtvLLEBFoJoRZ7xI=;
 b=
Received: from [10.109.238.111] (helo=vk6hgr.net.au)
	by smtpcorp.com with esmtpsa (TLS1.3:ECDHE_SECP256R1__RSA_PSS_RSAE_SHA256__AES_256_GCM:256)
	(Exim 4.98.1-S2G)
	(envelope-from <grogers@vk6hgr.echidna.id.au>)
	id 1ukHqy-4o5NDgrpInA-u2dm
	for linux-hams@vger.kernel.org;
	Fri, 08 Aug 2025 07:49:28 +0000
Received: from sidefw1.side.wa.edu.au ([159.196.89.25] helo=[192.168.1.55])
	by vk6hgr.net.au with esmtpsa  (TLS1.3) tls TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256
	(Exim 4.96)
	(envelope-from <grogers@vk6hgr.echidna.id.au>)
	id 1ukHqs-00CzZg-0E
	for linux-hams@vger.kernel.org;
	Fri, 08 Aug 2025 15:49:26 +0800
Message-ID: <0c6c5375-2b0e-42aa-bb1b-e676acd1dfa2@vk6hgr.echidna.id.au>
Date: Fri, 8 Aug 2025 15:49:22 +0800
Precedence: bulk
...
References: <7c4ff0c7c6faa8722e858c92f6456dc7@vanheusden.com>
 ...
 <70fb178a2d178398ce511cd8da54f62a@vanheusden.com>
Content-Language: en-GB
In-Reply-To: <70fb178a2d178398ce511cd8da54f62a@vanheusden.com>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 8bit
X-SA-Exim-Connect-IP: 159.196.89.25
X-SA-Exim-Mail-From: grogers@vk6hgr.echidna.id.au
X-Spam-Level:
X-Spam-DCC: sonic: voyager 1255; Body=2 Fuz1=2 Fuz2=2
Subject: Re: crash
X-SA-Exim-Version: 4.2.1 (built Wed, 06 Jul 2022 17:57:39 +0000)
X-SA-Exim-Scanned: Yes (on vk6hgr.net.au)
X-Report-Abuse: Please forward a copy of this message, including all headers, to <abuse-report@smtp2go.com>
Feedback-ID: 470653m:470653aQT1e3Y:470653sIVnVUWI9K
X-smtpcorp-track: D2SKTjBfSrRN.wpxAWw-8K2yO.kLNo4QdcUTf

That's really strange. I have a loopback AX.25 device so perhaps if you 
set something up similar this and test on the one device locally first, 
do you get any change in behaviour? So,

ax_call loop mycall-1

Should work with this set up.

- /usr/local/bin/loop_kiss

#/bin/bash
/usr/sbin/kissattach /dev/ptmx loop 44.136.204.77 >/tmp/loop_port.tmp
PORT=`cat /tmp/loop_port.tmp | grep dev\/ | head -1`
echo Attaching socat loop to $PORT
socat -d -d $PORT,raw,echo=1 $PORT,raw,echo=0 &

- /etc/ax25/axports
loop MYCALL-1 9600 250 6 Loopback device
...
On 8/08/2025 3:34 pm, Folkert van Heusden wrote:
> I tried to explain it with a drawing: https://vanheusden.com/permshare/ 
> ax25crash.png
> 
...
>>> Aug 07 19:32:05 27mc5 kernel: WARNING: CPU: 2 PID: 3487 at net/core/ 
>>> netpoll.c:365 __netpoll_send_skb+0x240/0x258
...
>>> snd_usb_audio rfkill snd_hwdep snd_usbmidi_lib spi_bcm2835 
>>> snd_rawmidi videobuf2_v4l2 i2c_brcmstb videodev v3d snd_compress 
>>> snd_pcm_dmaengine gpio_keys videobuf2_common snd_seq_device snd_pcm 
>>> gpu_sched drm_shmem_helper snd_timer pwm_fan drm_kms_helper mc snd 
>>> rp1_pio rp1_mailbox rp1_adc rp1_fw raspberrypi_gpiomem nvmem_rmem 
>>> sch_fq_codel fuse drm drm_panel_orientation_quirks backlight 
>>> nfnetlink ip_tables x_tables ipv6 uio_pdrv_genirq uio
>>> Aug 07 19:32:05 27mc5 kernel: CPU: 2 UID: 0 PID: 3487 Comm: kworker/ 
>>> u19:0 Not tainted 6.12.34+rpt-rpi-v8 #1  Debian 1:6.12.34-1+rpt1
...
>>> Aug 07 19:32:05 27mc5 kernel: el1h_64_sync_handler+0xa4/0xe8https:// 
>>> vanheusden.com/permshare/ax25crash.png
...
>>> Aug 07 19:32:05 27mc5 kernel:   GCS = 0, Overlay = 0, DirtyBit = 0, 
>>> Xs = 0
>>> Aug 07 19:32:05 27mc5 kernel: user pgtable: 4k pages, 39-bit VAs, 
>>> pgdp=0000000081c62000
>>> Aug 07 19:32:05 27mc5 kernel: [00000000000000d0] 
>>> pgd=0800000181627003, p4d=0800000181627003, pud=0800000181627003, 
>>> pmd=08000000c0927003, pte=0000000000000000
...
>>> sch_fq_codel fuse drm drm_panel_orientation_quirks backlight 
>>> nfnetlink ip_tables x_tables ipv6 uio_pdrv_genirq uio
>>> Aug 07 19:32:06 27mc5 kernel: CPU: 2 UID: 0 PID: 3487 Comm: kworker/ 
>>> u19:0 Tainted: G        W          6.12.34+rpt-rpi-v8 #1 Debian 
>>> 1:6.12.34-1+rpt1
