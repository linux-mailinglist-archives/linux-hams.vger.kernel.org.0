...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CF6985107C9
	for <lists+linux-hams@lfdr.de>; Tue, 26 Apr 2022 20:58:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345243AbiDZTB4 (ORCPT <rfc822;lists+linux-hams@lfdr.de>);
        Tue, 26 Apr 2022 15:01:56 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56858 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1345051AbiDZTBz (ORCPT
        <rfc822;linux-hams@vger.kernel.org>); Tue, 26 Apr 2022 15:01:55 -0400
X-Greylist: delayed 198 seconds by postgrey-1.37 at lindbergh.monkeyblade.net; Tue, 26 Apr 2022 11:58:44 PDT
Received: from einhorn-mail-out.in-berlin.de (einhorn.in-berlin.de [192.109.42.8])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 080851816F3
        for <linux-hams@vger.kernel.org>; Tue, 26 Apr 2022 11:58:43 -0700 (PDT)
X-Envelope-From: thomas@x-berg.in-berlin.de
Received: from x-berg.in-berlin.de (x-change.in-berlin.de [217.197.86.40])
        by einhorn.in-berlin.de  with ESMTPS id 23QIt5bu017477
        (version=TLSv1.3 cipher=TLS_AES_256_GCM_SHA384 bits=256 verify=NOT);
        Tue, 26 Apr 2022 20:55:05 +0200
Received: from thomas by x-berg.in-berlin.de with local (Exim 4.94.2)
        (envelope-from <thomas@x-berg.in-berlin.de>)
        id 1njQL3-0006nE-CP; Tue, 26 Apr 2022 20:55:05 +0200
Date:   Tue, 26 Apr 2022 20:55:05 +0200
From:   Thomas Osterried <thomas@osterried.de>
To:     linux-hams@vger.kernel.org
Cc:     jreuter@yaina.de, arnd@arndb.de, Jakub Kicinski <kuba@kernel.org>
Subject: Re: [PATCH net-next 6/6] net: hamradio: remove support for DMA SCC
 devices
Message-ID: <YmhACVaakjATNFl4@x-berg.in-berlin.de>
References: <20220426175436.417283-1-kuba@kernel.org>
 <20220426175436.417283-7-kuba@kernel.org>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20220426175436.417283-7-kuba@kernel.org>
...
Anyone out there who still use that hardware?


What are we talking about?
Ottawa PI2 (Packet Interface 2) Card
  https://pc7x.net/archive/mirrors/pi8zaa/packet/scc/pi2b/pi2b.htm
  Website was updated in 1997.

In his theses (2003), the author complained that dmascc driver was still not
in the linux kernel ;)


The hardware is old. But isn't it also the strength of linux kernel, that
it supports old hardware you accidently find on the garret?
Well, on the other hand, you'll have to find an ISA-to-thunderbold4-adapter too ;))


If the code should reside inside, it obviously requires to be modernized
(VIRT_TO_BUS). I think, users of that card will at least help to test such
a port.


NB: "no real changes to git history" - this could be a sign of quality:
good code, stable, all features implemented, finished.
...
On Tue, Apr 26, 2022 at 10:54:36AM -0700, Jakub Kicinski wrote:
